...
public class NeighbourProfileActivity extends AppCompatActivity {
    ...
    private static boolean fillOrNot = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null)
            fillOrNot = savedInstanceState.getBoolean("star");
    }
    ...
    public void changeStar() {
        ...
        if(fillOrNot){
            ...
            fillOrNot = false;} //REND FAVORIS
        else{
            fav.setImageResource(R.drawable.ic_star_border_white_24dp);
            fillOrNot = true; //REND NON FAVORIS
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBoolean("star", fillOrNot);
    }
}
